...
const ReviewFormP=(props)=>{
  ...
  gtSlotQR = () =>{
    ...
    fetch('http://192.168.1.157/php_parkProj/ReturnParkQr.php', {
      method: 'POST',
      headers: {
  ...
  ReserveParking = () =>{
    ...
    fetch('http://192.168.1.157/php_parkProj/ParkingReservation.php', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
  ...
  const TestEmail = () =>{
    ...
    fetch('http://192.168.1.157/php_parkProj/ParkingBooking.php', {
      method: 'POST',
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
           ...
           {gtSlotQR()}
            <Modal  visible={ModaleOpen} animationType="fade" >
                ...
                <View style={styles.qrContainer}>
                    <Text style={styles.txtqr}>Slot QR code</Text>
                <QRCode
                value={qrdata}
                color="#011424"
